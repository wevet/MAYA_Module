...
class AboutMenu:
    def __init__(self):
        ...
        windowAbout = mc.window('AboutFacial', title='About this script', resizeToFitChildren=False, h=400,
                                sizeable=True, w=500)
        ...
        tutoVimeo = str(
            '<!DOCTYPE html> <html> <a href="https://vimeo.com/album/3982065" target="_top"> https://vimeo.com/album/3982065</a><a href="https://vimeo.com/album/3982065" target="_top"> </html>')
        tutoYoutube = str('!')
        mc.rowLayout(nc=2)
        ...
        HelpEmail = str(
            '<!DOCTYPE html> <html> <a href="https://ludovic.faucillon@gmail.com" target="_top"> ludovic.faucillon@gmail.com</a><a href="https://ludovic.faucillon@gmail.com" target="_top"> </html>')
        ...
        mc.text(
            l='Nicolas Galvanni (head of rigging in Norman Studio) / Thierry Defossez (beta test) / Fabien Coulon (producer at Norman Studio)',
            fn='boldLabelFont')
